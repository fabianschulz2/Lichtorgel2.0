...
namespace __Interop
{
	...
	{
		// Signature, memcpy, [fwd] [return] [EETypeRva:0x000419B0] byte___ptrunsigned char *, [fwd] [in] [EETypeRva:0x000419B0] byte___ptrunsigned char *, [fwd] [in] [EETypeRva:0x000419B0] byte___ptrunsigned char *, [fwd] [in] [EETypeRva:0x000419B0] int__int, 
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("Accord, Version=3.8.0.0, Culture=neutral, PublicKeyToken=null", "Accord.SystemTools", "memcpy")]
		public static byte* memcpy(
					byte* dst, 
					byte* src, 
					int count)
		{
			...
			unsafe___value = (byte*)global::__Interop.ntdll_dll_PInvokes.memcpy(
								((byte*)dst), 
								((byte*)src), 
								count
							);
		...
		// Signature, memset, [fwd] [return] [EETypeRva:0x000419B0] byte___ptrunsigned char *, [fwd] [in] [EETypeRva:0x000419B0] byte___ptrunsigned char *, [fwd] [in] [EETypeRva:0x000419B0] int__int, [fwd] [in] [EETypeRva:0x000419B0] int__int, 
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("Accord, Version=3.8.0.0, Culture=neutral, PublicKeyToken=null", "Accord.SystemTools", "memset")]
		public static byte* memset(
					byte* dst, 
					int filler, 
					int count)
		{
			...
			// Marshalling
			// Call to native method
			unsafe___value = (byte*)global::__Interop.ntdll_dll_PInvokes.memset(
								((byte*)dst), 
								filler, 
								count
							);
	...
	public unsafe static partial class ntdll_dll_PInvokes
	{
		public static byte* memcpy(
					...
					int count)
		{
			throw new global::System.TypeLoadException("Unresolved P/Invoke method \'ntdll.dll!memcpy\' from this method. Please look for this method in build warnings fo" +
					"r more details. ");
		}
		...
		public static byte* memset(
					...
					int count)
		{
			throw new global::System.TypeLoadException("Unresolved P/Invoke method \'ntdll.dll!memset\' from this method. Please look for this method in build warnings fo" +
					"r more details. ");
		}
	}
